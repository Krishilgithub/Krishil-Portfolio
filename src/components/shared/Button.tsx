...
const Button = ({
  ...
  const variants = {
    ...
    secondary: 'bg-[#FF61D8] text-white hover:bg-[#EF51C8] focus:ring-[#FF61D8]',
    outline: 'border-2 border-[#7B61FF] text-[#7B61FF] hover:bg-[#7B61FF] hover:text-white focus:ring-[#7B61FF]',
  };
