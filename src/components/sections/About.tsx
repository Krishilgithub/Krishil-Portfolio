  ...
  return (
    <section id="about" className="py-24 bg-[#0A192F] relative">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {webSkills.map((skill, index) => (
              ...
              >
                <Card glassEffect className={`h-full border-t-4 ${skill.colorClass}`}>
                  <div className="flex flex-col items-center p-4">
                    ...
                    <h4 className="text-[#CCD6F6] font-semibold text-lg mb-2">{skill.name}</h4>
                    ...
                    <span className="text-sm text-[#8892B0]">Proficiency: {skill.level}%</span>
                  </div>
                </Card>
              </motion.div>
            ))}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            {tools.map((tool, index) => (
              ...
              >
                ...
                <h4 className="text-[#CCD6F6] font-medium text-sm text-center">{tool.name}</h4>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <Card glassEffect className="backdrop-blur-lg border border-[#233554]/50">
