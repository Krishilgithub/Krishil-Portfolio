      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {contactMethods.map((method, index) => (
                    <div key={index} className="flex items-center group">
                      ...
                      <div>
                        <h4 className="text-[#CCD6F6] font-medium">{method.name}</h4>
                        <p className="text-sm text-[#8892B0] group-hover:text-[#7B61FF] transition-colors">{method.value}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            >
              <Card glassEffect className="p-6">
                <h3 className="text-xl font-bold text-[#CCD6F6] mb-4">Let's Collaborate</h3>
                <p className="text-[#8892B0] mb-6">
                  I'm open to various collaboration opportunities in machine learning and data science.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {collaborationTypes.map((collab, index) => (
                    <div key={index} className="bg-[#172A44] p-4 rounded-lg border border-[#233554] hover:border-[#7B61FF] transition-colors">
                      <div className="text-2xl mb-2">{collab.icon}</div>
                      <h4 className="text-[#CCD6F6] font-medium mb-1">{collab.title}</h4>
                      <p className="text-sm text-[#8892B0]">{collab.description}</p>
                    </div>
                  ))}
                </div>
              </Card>
          ...
          >
            <Card glassEffect className="p-6">
              <h3 className="text-xl font-bold text-[#CCD6F6] mb-4">Send a Message</h3>
              <p className="text-[#8892B0] mb-6">
                Have a specific question or project in mind? Fill out the form below with the details.
              </p>
        ...
        >
          <Card glassEffect className="p-4 border border-[#233554]">
            <p className="text-[#8892B0] text-sm">
              <span className="gradient-text font-medium">Fast Response Guarantee</span> — I commit to responding to all inquiries within 48 hours. Your projects and collaborations are important to me!
            </p>
          </Card>
        </motion.div>
      </div>
